  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#07090f] text-zinc-50">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-[0.14] bg-[linear-gradient(to_right,rgba(255,255,255,0.16)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-size-[52px_52px]" />
        ...
        <div className="absolute -right-36 top-12 h-168 w-120 rotate-12 border border-cyan-200/10 bg-[linear-gradient(160deg,rgba(34,211,238,0.14),rgba(244,63,94,0.06)_52%,transparent)]" />
        <div className="absolute -bottom-44 -left-24 h-112 w-184 -rotate-6 border border-emerald-200/10 bg-[linear-gradient(135deg,rgba(16,185,129,0.16),rgba(250,204,21,0.08)_45%,transparent_75%)]" />
